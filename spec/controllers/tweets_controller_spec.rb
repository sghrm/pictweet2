...
describe TweetsController do
	describe 'GET #new' do
		it "renders the :new template" do #期待したビューに遷移するか
			get :new #リクエストを行なったことにするコード
	...
	describe 'GET #edit' do
		it "assigns the requested tweet to @tweet" do
			tweet = create(:tweet)
			get :edit, id: tweet #インスタンスのidをセットすることができる
	...
	describe 'GET #index' do
		it "populates an array of tweets ordered by created_at DESC" do
			tweets = create_list(:tweet, 3) #tweetレコードを3つ保存して、tweetsに代入
			get :index
